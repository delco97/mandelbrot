...
1. Download the source code from the project's GitHub repository: https://github.com/delco97/mandelbrot.
2. Open the `MandelbrotSet.pde` file in Processing.
...
1. Open the `MandelbrotSet.pde` file in Processing.
